...
public class MultiPartTest implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {

    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent event, Context context) {
        //Create the logger
        LambdaLogger logger = context.getLogger();
        logger.log("Please change");
        logger.log("dsasadasdas");
        ...
        String bucketName = "infosys-chester";
        ...
        try {
            ...
            response.setBody("File stored in S3");
